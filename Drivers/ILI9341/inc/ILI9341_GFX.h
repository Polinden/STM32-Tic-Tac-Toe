...
#define DISP_RST_RESET      HAL_GPIO_WritePin(TFT_RESET_GPIO_Port, TFT_RESET_Pin, GPIO_PIN_RESET)
#define DISP_RST_WORK       HAL_GPIO_WritePin(TFT_RESET_GPIO_Port, TFT_RESET_Pin, GPIO_PIN_SET)
...
void ILI9341_Write_Data1(unsigned char * pData, int numBytes);
void ILI9341_Write_Data2(unsigned char pData);
